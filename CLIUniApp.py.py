...
class Student:
  ...
  def is_valid_password(self, password):
    return bool(re.match( r"^[A-Z].{8,}[0-9]{3}$", password))
...
class Database:
  ...
  def save_students(self, students):
    data = [{"first_name": s.first_name, "last_name": s.last_name, "email": s.email, "password": s.password, "enrolled_subjects": [{ "mark": subj.mark, "grade": subj.grade } for subj in s.enrolled_subjects]} for s in students]
              ...
              case 'r':
                ...
                if new_student:
                  ...
                  print("Registration successful! Please login to proceed.")
                   ...
                   print(f"Student {students.first_name}{self.students.last_name} already exists.")
        ...
        match choice:
            ...
            case 'c':
                ...
                if student.is_valid_password(new_password):
                    ...
                    print("Note: Password must have at least 5 characters, begin with an uppercase and last three characters must be digits.")
